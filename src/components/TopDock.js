...
export default function TopDock() {
  return (
    <div className="fixed top-0 left-0 z-50 w-full h-20 glass-nav" >
      <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
        <button
          type="button"
          class="inline-flex flex-col items-center justify-center px-5 hover:bg-yellow-200 group"
        >
          <img src="/bg.png" className="w-8" alt="bg" />
